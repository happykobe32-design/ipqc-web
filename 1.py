...
if selected_model:
    ...
    if selected_modules:
        ...
        # ==== ✅ 上傳到 Google Drive ====
                    ...
                    SERVICE_ACCOUNT_FILE = 'ipqc-access.json'  # 放在根目錄
                    FOLDER_ID = '1DfzSY5zeDaeLlsdWGB78wwxrQazxeX3h'  # 你提供的 Google Drive 資料夾 ID
                    ...
                    try:
                        ...
                        media = MediaFileUpload(save_path, mimetype='application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')
                        ...
                        st.success(f"✅ 檔案已成功同步上傳至 Google Drive！")
